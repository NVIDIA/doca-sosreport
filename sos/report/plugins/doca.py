...
class Doca(Plugin, IndependentPlugin):
    ...
    def setup(self):
        ...
        doca_commands_file = '/opt/mellanox/doca/extensions/doca_commands'
        ...
        doca_logs = '/opt/mellanox/doca/extensions/doca_logs'
        ...
        doca_script = '/opt/mellanox/doca/extensions/doca_script.sh'
